...
class Contenir(models.Model):
    ...
    refProd = models.ForeignKey(Produit, on_delete=models.CASCADE, related_name="contenir")
    idRayon = models.ForeignKey(Rayon, on_delete=models.CASCADE, related_name="contenir")
